...
✅ PLAN.md task format: Goal, Files, Validation, §8 refs
✅ Task progress comments only — never rewrite task bodies
❌ Invent tasks not in PLAN.md
Links: writing-plans, docs-sync
